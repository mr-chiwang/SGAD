...
const imageSeletorPaths = [
  "./image_selector/input/megadepth1_ori.png",
  "./image_selector/input/megadepth2_ori.png",
  "./image_selector/input/scannet1_ori.png",
  "./image_selector/input/scannet2_ori.png"
];

const outputImagesPathsStr = [
  "./image_selector/output/megadepth1.png",
  "./image_selector/output/megadepth2.png",
  "./image_selector/output/scannet1.png",
  "./image_selector/output/scannet2.png"
];
    ...
    <el-row justify="center">
      <el-col :xs="24" :sm="20" :md="16" :lg="12" :xl="12">
        <el-row justify="space-evenly" style="margin-top: 20px;">
          <el-col :span="6" v-for="(imageSeletorPath, index) in imageSeletorPaths" :key="index">
            <el-image 
              class="image"  
